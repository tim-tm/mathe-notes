...
\begin{axis}[
    ...
    \addplot[red,ultra thick,name path=A] ({\x},{-((\x)*(\x))+4});
...
\begin{axis}[
    ...
    \addplot[red,ultra thick,name path=A] ({\x},{-((\x)*(\x))+4});
    \addlegendentry{\(f(x)\)};
    \addplot[blue,ultra thick,name path=B] ({\x},{2});
    \addlegendentry{\(g(x)\)};
...
\begin{axis}[
    ...
    \addplot[blue,ultra thick,name path=B] ({\x},{8/3});
...
\begin{axis}[
    ...
    \addplot[red,ultra thick,name path=A] ({\x},{((\x)*(\x))});
    \addlegendentry{\(f(x)\)};
...
\begin{axis}[
    ...
    \addplot[blue,ultra thick,name path=B] ({\x},{-((\x)*(\x))});
    \addlegendentry{\(-x^2\)};
